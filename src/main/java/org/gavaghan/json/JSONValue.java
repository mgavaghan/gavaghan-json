...
public interface JSONValue
{
    ...
    * 
    * @return create a new <code>JSONValue</code> that has the same implementation
    *         as this instance
    */
   ...
   /**
    * Render this <code>JSONValue</code> to a <code>Writer</code>. There's
    * generally no reason to call this method directly. It is intended to be
    * overridden by an extended type.
    * 
